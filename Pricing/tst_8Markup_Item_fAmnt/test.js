function main()
{
    ...
    loginAppl("CONFIGURE"); 
    snooze(6);
    test.log("********* Markup Prcing Scheule by an Item with Fixed Amount *********");
    //----------------- Mark Up by Item for Customer -------------------
    test.log("********* Markup by an Item for Customer **************");
    //------- Variable declaration -----
    var targetItem1 = "MARKUPITEM4";
    var mPSName1 = "Mark-up by Item vth fAmnt";
    var mCustName1 = "MCUST6";
    ...
    //------- Variable declaration -----
    var targetItem2 = "MARKUPITEM4";
    var mPSName2 = "CSTMark-up by Item vth fAmnt";
    var mCustName2 = "MCUST7";
    ...
    //------- Variable declaration -----
    var targetItem3 = "MARKUPITEM4";
    var mPSName3 = "CSTPatMark-up by Item vth fAmnt";
    var mCustName3 = "MCUST8";
  ...
  //------- Variable declaration -----
  var targetItem4 = "MARKUPITEM5";
  var mPSName4 = "CTypeMark-up by Item vth fAmnt";
  var mCustName4 = "MCUST9";
  var  shipToNum4 = "STORE1";
  var custType4 = "MTYPE3";
  var custTypeAss4 = "MTYPE3"+"-"+"MTYPE3";
  var markupP4 = 25;
  ...
  catch(e)
  {
    ...
    //------- Variable declaration -----
    var targetItem5 = "MARKUPITEM6";
    var mPSName5 = "CTypePatMark-up by Item vth fAmnt";
    var mCustName5 = "MCUST10";
    var  shipToNum5 = "STORE1";
    var custType5 = "MTYPE4";
    var custTypeAss5 = "MTYPE4"+"-"+"MTYPE4";
    var markupP5 = 30;
