function main()
{
 //-----includes-----
    ...
    test.log("********* Markup Pricing Schedule by Product Category with specific Percentage ***********");
//    //----------------- Mark Up by Product Category for Customer -------------------
//    test.log("********* Markup by Product Category for Customer **************");
//    //------- Variable declaration -----
//    var targetItem1 = "MARKUPITEM7";
//    var mPSName1 = "Mark-up by Product Category1";
//    var mCustName1 = "MCUST11";
//    var custType1 = "NORMAL"+"-"+"Normal Domestic Customers";
//    var prcAssg1 = mPSName1 +" - " +"Markup Pricing Schedule"; 
//    var markup1 = 10;
//    var productCat1 = "PRODUCT CATEGORY 1";
...
//    //------- Variable declaration -----
//    var targetItem2 = "MARKUPITEM7";
//    var mPSName2 = "CSTMark-up by Product Cat";
//    var mCustName2 = "MCUST12";
//    var  shipToNum2 = "STORE2";
//    var custType2 = "NORMAL"+"-"+"Normal Domestic Customers";
//    var markupP2 = 15;
//    var prcAssg2 = mPSName2 +" - " +"Customer ShipTo Markup"; 
//    var productCat2 = "PRODUCT CATEGORY 1";
...
//    //------- Variable declaration -----
//    var targetItem3 = "MARKUPITEM7";
//    var mPSName3 = "CSTPatMark-up by PC";
//    var mCustName3 = "MCUST13";
//    var  shipToNum3 = "STORE3";
//    var custType3 = "NORMAL"+"-"+"Normal Domestic Customers";
//    var markupP3 = 20;
//    var prcAssg3 = mPSName3 +" - " +"Cust ShipTo Patt Markup"; 
//    var pat = ".*";
//    var productCat3 = "PRODUCT CATEGORY 1";
...
//    
    ...
    //------- Variable declaration -----
    var targetItem4 = "MARKUPITEM8";
    var mPSName4 = "CTypeMark-up by PC";
    var mCustName4 = "MCUST14";
    var  shipToNum4 = "STORE1";
    var custType4 = "MTYPE5";
    var custTypeAss4 = "MTYPE5"+"-"+"MTYPE5";
    var markupP4 = 25;
    var prcAssg4 = mPSName4 +" - " +"Markup Cust Type"; 
    var pat = ".*";
    var productCat4 = "PRODUCT CATEGORY 2";
...
//    createCustomer(custTypeAss4,mCustName4,shipToNum4);
  //-------  New item creation ----
    ...
    //------- Variable declaration -----
    var targetItem5 = "MARKUPITEM8";
    var mPSName5 = "CTypePatMark-up by PC";
    var mCustName5 = "MCUST15";
    var  shipToNum5 = "STORE1";
    var custType5 = "MTYPE6";
    var custTypeAss5 = "MTYPE6"+"-"+"MTYPE6";
    var markupP5 = 30;
    var prcAssg5 = mPSName5 +" - " +"Markup Cust Type"; 
    var pat = ".*";
      var productCat5 = "PRODUCT CATEGORY 3";
