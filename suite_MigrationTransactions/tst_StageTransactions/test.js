  ...
  catch(e)
  {
    ...
    try
    {
        ...
        try
        {
            ...
            openItemContextMenu(":_list_XTreeWidget_15", INNUM, 5, 5, 0);
    ...
    try
    {
        ...
        try
        {
            ...
            waitForObject(":_list_XTreeWidget_15");
            if(!clickItem(":_list_XTreeWidget_15", INNUM, 5, 5, 1, Qt.LeftButton))
    ...
    try
    {
        ...
        waitForObject(":_groupButton.VirtualClusterLineEdit_ExpenseLineEdit");
        type(":_groupButton.VirtualClusterLineEdit_ExpenseLineEdit", "OFFICE");
        nativeType("<Tab>");
        snooze(0.5); 
...
//        clickButton(":*.Yes_QPushButton");     
    ...
    try{
        ...
        mouseClick(waitForObject(":Item Reservations.ItemLineEdit_ItemLineEdit"), 13, 9, 0, Qt.LeftButton);
        type(waitForObject(":Item Reservations.ItemLineEdit_ItemLineEdit"), "BTRUCK1");
        nativeType("<Tab>");
        mouseClick(waitForObject(":_qtyGroup._qty_XLineEdit"), 32, 18, 0, Qt.LeftButton);
        type(waitForObject(":_qtyGroup._qty_XLineEdit"), "500");
        nativeType("<Tab>");
        type(waitForObject(":_documentNum_XLineEdit"), "123");
        type(waitForObject(":_documentNum_XLineEdit"), "<Tab>");
        clickButton(waitForObject(":W/O Schedule by Planner Code.Post_QPushButton"));
        clickButton(waitForObject(":W/O Schedule by Planner Code.Cancel_QPushButton"));
        test.log("Qty of BTRUCK1 has been adjusted successfully");
    }
    catch(e)
    {
        test.fail("Error in posting the adjustment for BTRUCK1 item"+e);
    }
