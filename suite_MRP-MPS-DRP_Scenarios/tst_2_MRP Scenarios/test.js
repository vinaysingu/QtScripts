  ...
  try
    {
        ...
        snooze(0.5);
        waitForObject(":_availabilityStack.Create Work Order_QGroupBox_2");
        if(findObject(":_availabilityStack.Create Work Order_QGroupBox_2").checked)
            type(":_availabilityStack.Create Work Order_QGroupBox_2"," ");
