function main()
{
  ...
  //---find Application Edition------
    ...
    {	
        ...
        var linuxPath = findObject(":_stack_FileLineEdit_2").text;
        waitForObject(":_stack_FileLineEdit");
        var winPath = findObject(":_stack_FileLineEdit").text;
    ...
    if(appEdition == "PostBooks")
    {
        ...
        {
            test.fail("Error in enabling EFT Check Printing "+e);
        }
        ...
        try{
            ...
            clickItem(":Cash Receipt._currency_XComboBox","EUR - €", 0, 0, 5, Qt.LeftButton);
    ...
    try
    {
        ...
        if(object.exists(":Sales Order.OK_QPushButton_2"))
        {
            test.log("accounting period is closed");
    ...
    try
    {
        ...
        sendEvent("QMouseEvent", ":_frame.Post_QPushButton", QEvent.MouseButtonPress, 42, 10, Qt.LeftButton, 0);
        activateItem(waitForObjectItem(":_QMenu", "Selected Check..."));                
        clickButton(waitForObject(":List Unposted Invoices.Post_QPushButton"));        snooze(1);
        clickButton(waitForObject(":Select Order for Billing.Close_QPushButton"));
    }
    catch(e)
    {
