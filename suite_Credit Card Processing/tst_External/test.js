  ...
  catch(e)
  {
   ...
   //--------------- Set the window to Tab view mode -------------
    ...
    try{
        ...
        clickItem(":_stack._orderNumGeneration_NumberGenComboBox", "Automatic",0, 0, 5, Qt.LeftButton);
        var sonumber = findObject(":_stack._nextSoNumber_XLineEdit").text;
        clickButton(waitForObject(":Cash Receipt.Save_QPushButton_3"));
        test.log("Next Sales order Number is "+sonumber+"");
    }
    catch(e)
    {
        test.fail("Error in finding the next sales order number" +e);
    }
    var sonumber1 = sonumber;
    
    //------ Verifying the Customers for Active Credit Cards -----
    try
    {
        var pat = "Yes";
        ...
        waitForObject(":_list_XTreeWidget_3");
         doubleClickItem(":_list_XTreeWidget_3", "TTOYS", 20, 9, 0, Qt.LeftButton);
        waitForObject(":Sales Order.qt_tabwidget_tabbar_QTabBar");
        ...
        snooze(1);
        waitForObjectItem(":_list_XTreeWidget_3", "XTRM");
        doubleClickItem(":_list_XTreeWidget_3", "XTRM", 20, 9, 0, Qt.LeftButton);
    ...
    try{
        ...
        // ----Finding the allocated amount and Comparing it with so amount --------
        waitForObject(":Quotes.Query_QToolButton");
        clickButton(":Quotes.Query_QToolButton");
        waitForObject(":_list_XTreeWidget_3");
        openItemContextMenu(":_list_XTreeWidget_3",sonumber1 ,5, 5, Qt.LeftButton);
    ...
    var sonumber3 = ++sonumber;
    var soamnt3 = createandreturnSalesOrderamnt("YTRUCK1", "100");
    ...
    try{
        ...
        //-------Comparing the Charged amount with allocated amount -----
        waitForObject(":Quotes.Query_QToolButton");
        clickButton(":Quotes.Query_QToolButton");
        waitForObject(":_list_XTreeWidget_3");
        openItemContextMenu(":_list_XTreeWidget_3", sonumber3 ,5, 5, Qt.LeftButton);
